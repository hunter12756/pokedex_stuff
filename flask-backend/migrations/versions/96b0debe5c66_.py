...
Revision ID: 96b0debe5c66
Revises: 
Create Date: 2023-08-24 18:07:26.482306
...
def upgrade():
    ...
    sa.Column('type', sa.Enum('fire,electric,normal,ghost,psychic,water,bug,dragon,grass,fighting,ice,flying,poison,ground,rock,steel'), nullable=True),
